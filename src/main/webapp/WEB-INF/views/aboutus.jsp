...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="bs.html">Home</a></li>
      <li class="dropdown">
 ...
 <form>
 <p>
 Bangles made from sea shell, copper, bronze, gold, agate, chalcedony, etc. have been excavated from multiple archaeological sites throughout India. A figurine of a dancing girl wearing bangles on her left arm has been excavated from Mohenjo-daro .

Other early examples of bangles in India include copper samples from the excavations at Mahurjhari, followed by the decorated bangles belonging to the Mauryan empire  and the gold bangle samples from the historic site of Taxila . Decorated shell bangles have also been excavated from multiple Mauryan sites. Other features include copper rivets and gold-leaf inlay in some cases.
